...
def salvar_item(layout_id: int, grupo_id: int, nome_item_excel: str, palavra_busca: str, ordem: int, exportar_excel: int = 1) -> bool:
...
def atualizar_item(item_id: int, layout_id: int, nome_item_excel: str, palavra_busca: str, ordem: int, exportar_excel: int = 1) -> bool:
    nome_item_excel = nome_item_excel.strip().upper()
    palavra_busca = palavra_busca.strip()
    if not nome_item_excel or not palavra_busca: return False
